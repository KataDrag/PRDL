...
# Upewnij się, że inne zmienne kategoryczne (np. Cervical) są zakodowane (jeśli dotyczy)
# df['Cervical'] = df['Cervical'].map({'value1': 1, 'value2': 0})  # Dostosuj mapowanie, jeśli jest konieczne
